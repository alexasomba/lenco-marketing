/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 771d1afe33c3f3b299d012404a4bd86b)
...
declare namespace Cloudflare {
	interface Env {
		...
		VITE_BLOG_DESCRIPTION: string;
		VITE_DOCS_DESCRIPTION: string;
		GITHUB_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_SITE_URL" | "VITE_SITE_NAME" | "VITE_SITE_DESCRIPTION" | "VITE_BLOG_DESCRIPTION" | "VITE_DOCS_DESCRIPTION" | "GITHUB_TOKEN" | "GITHUB_ISSUE_OWNER" | "GITHUB_ISSUE_REPO" | "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID" | "GITHUB_APP_PRIVATE_KEY" | "INKEEP_API_KEY">> {}
}
